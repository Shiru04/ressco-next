  ...
  return (
    <html lang="en">
      <body>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-xl focus:bg-white focus:px-4 focus:py-3 focus:text-sm focus:font-semibold focus:text-black focus:shadow-soft focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2"
        >
          Skip to content
        </a>
        <Header />
